...
#for k in xrange(n_bins):
#    h_before_selection.Fill(bin_value_dict[k], off_set)
#    h_true.Fill(bin_value_dict[k]            , off_set)
...
#############################################################
# this part should have been the easiest way, but we need the 'reverse' version of the cumulation
"""
...
# calculating the reverse cumulative histogram:
###############################################################
'''
cum_tp = 0
cum_fp = 0
